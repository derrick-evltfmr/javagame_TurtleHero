...
public class CompressedIceBerg extends GameFigure {

    public static final int UNIT_MOVE = 5;
    public static final int INIT_ICEBERG_EXPLOCDCOUNT = 0;
    public static final int MAX_ICEBERG_EXPLODECOUNT = 5;
    ...
    int explodeCount = INIT_ICEBERG_EXPLOCDCOUNT;
    ...
    CompressedIceBergAnimStrategy animStrategy;


    boolean endExplosion = false;

    Color lightColor = new Color (173,233,213); // 155-255
    Color deepColor = new Color (123,233,213); // the smallest one -100
    Color whiteColor = new Color(233, 230, 224);


    public CompressedIceBerg(int startx, int starty) { // startx starty is from the shooting enemy
...
//        System.out.println(theta);  //shooting down is 90
        ...
        animStrategy = new CompressedIceBergAnimShooting(this); // pass the bubble obj itself to strategy
...
//        //143L
            ...
            int[] y2 = {(int) location.y - 20, (int) location.y - 10, (int) location.y - 10};
...
//        g2.drawPolygon(x2,y2,3);
            ...
            if (rotateshoot == true) g2.fill(xy2T);
            else g2.fill(xy2);
...
//        //145D
            ...
            int[] y3 = {(int) location.y - 20, (int) location.y - 10, (int) location.y - 12};
            g2.setColor(deepColor);
...
//        g2.drawPolygon(x3,y3,3);
            ...
            if (rotateshoot == true) g2.fill(xy3T);
            else g2.fill(xy3);


//
//        //23 1312 L
            int[] x4 = {(int) location.x - 10, (int) location.x - 4, (int) location.x - 4, (int) location.x - 10};
...
//        g2.drawPolygon(x4,y4,4);
            ...
            if (rotateshoot == true) g2.fill(xy4T);
            else g2.fill(xy4);
...
//        g2.drawPolygon(x5,y5,4);
            ...
            if (rotateshoot == true) g2.fill(xy5T);
            else g2.fill(xy5);
...
//        g2.drawPolygon(x6,y6,4);
            ...
            if (rotateshoot == true) g2.fill(xy6T);
            else g2.fill(xy6);
...
//        g2.drawPolygon(x7,y7,4);
            ...
            if (rotateshoot == true) g2.fill(xy7T);
            else g2.fill(xy7);
...
//        g2.drawPolygon(x8,y8,4);
            ...
            if (rotateshoot == true) g2.fill(xy8T);
            else g2.fill(xy8);
...
//        g2.drawPolygon(x9,y9,4);
            ...
            if (rotateshoot == true) g2.fill(xy9T);
            else g2.fill(xy9);

//
//        //67 10 D
            int[] x10 = {(int) location.x - 10, (int) location.x - 4, (int) location.x - 0};
            int[] y10 = {(int) location.y + 12, (int) location.y + 10, (int) location.y + 20};
            g2.setColor(deepColor);
...
//        g2.drawPolygon(x10,y10,3);
            ...
            if (rotateshoot == true) g2.fill(xy10T);
            else g2.fill(xy10);

//
//        //87 10 L
            int[] x11 = {(int) location.x + 4, (int) location.x - 4, (int) location.x - 0};
            int[] y11 = {(int) location.y + 10, (int) location.y + 10, (int) location.y + 20};
            g2.setColor(lightColor);
...
//        g2.drawPolygon(x11,y11,3);
            ...
            if (rotateshoot == true) g2.fill(xy11T);
            else g2.fill(xy11);

//
//        //89 10 D
            int[] x12 = {(int) location.x + 4, (int) location.x + 10, (int) location.x + 0};
            int[] y12 = {(int) location.y + 10, (int) location.y + 12, (int) location.y + 20};
            g2.setColor(deepColor);
...
//        g2.drawPolygon(x12,y12,3);
            ...
            if (rotateshoot == true) g2.fill(xy12T);
            else g2.fill(xy12);
...
//        g2.rotate((int)(theta), super.location.x, super.location.y);
            ...
            int[] y1 = {(int) location.y - 20-explodeCount, (int) location.y - 12-explodeCount, (int) location.y - 10-explodeCount};
            g2.setColor(deepColor);
            Polygon xy1 = new Polygon(x1, y1, 3);
            Shape xy1T = transformTheta.createTransformedShape(xy1);
            if (rotateshoot == true) g2.fill(xy1T);
...
//        //143L
            int[] x2 = {(int) location.x + 0, (int) location.x + 4, (int) location.x - 4};
            int[] y2 = {(int) location.y - 20-explodeCount, (int) location.y - 10-explodeCount, (int) location.y - 10-explodeCount};
            g2.setColor(lightColor);
//        g2.fillPolygon(x2,y2,3);
//        g2.setColor(whiteColor);
//        g2.drawPolygon(x2,y2,3);
...
//        //145D
            ...
            int[] y3 = {(int) location.y - 20-explodeCount, (int) location.y - 10-explodeCount, (int) location.y - 12-explodeCount};
            g2.setColor(deepColor);
//        g2.fillPolygon(x3,y3,3);
//        g2.setColor(whiteColor);
//        g2.drawPolygon(x3,y3,3);
...
//
//        //23 1312 L
            int[] x4 = {(int) location.x - 10-explodeCount, (int) location.x - 4-explodeCount, (int) location.x - 4-explodeCount, (int) location.x - 10-explodeCount};
...
//
//        //45 1514 L
            int[] x6 = {(int) location.x + 4+explodeCount, (int) location.x + 10+explodeCount, (int) location.x + 10+explodeCount, (int) location.x + 4 +explodeCount};
...
//
//        //67 1312 L
            int[] x7 = {(int) location.x - 10-explodeCount, (int) location.x - 4-explodeCount, (int) location.x - 4-explodeCount, (int) location.x - 10-explodeCount};
...
//
//        //89 1514 L
            int[] x9 = {(int) location.x + 4+explodeCount, (int) location.x + 10+explodeCount, (int) location.x + 10+explodeCount, (int) location.x + 4+explodeCount};
...
//        //67 10 D
            ...
            int[] y10 = {(int) location.y + 12+explodeCount, (int) location.y + 10+explodeCount, (int) location.y + 20+explodeCount};
            g2.setColor(deepColor);
//        g2.fillPolygon(x10,y10,3);
//        g2.setColor(whiteColor);
//        g2.drawPolygon(x10,y10,3);
...
//        //87 10 L
            int[] x11 = {(int) location.x + 4, (int) location.x - 4, (int) location.x - 0};
            int[] y11 = {(int) location.y + 10+explodeCount, (int) location.y + 10+explodeCount, (int) location.y + 20+explodeCount};
            g2.setColor(lightColor);
//        g2.fillPolygon(x11,y11,3);
//        g2.setColor(whiteColor);
//        g2.drawPolygon(x11,y11,3);
...
//        //89 10 D
            ...
            int[] y12 = {(int) location.y + 10+explodeCount, (int) location.y + 12+explodeCount, (int) location.y + 20+explodeCount};
            g2.setColor(deepColor);
//        g2.fillPolygon(x12,y12,3);
//        g2.setColor(whiteColor);
//        g2.drawPolygon(x12,y12,3);
    ...
    private void updateState() {
        ...
        if (state == STATE_SHOOTING ) { // travelling mode
            if (hitCount > 0 || thLocation.distance(location) <= 10.0 || location.y+0 > 680) {
                ...
                animStrategy = new CompressedIceBergAnimExploding(this);
                if (location.y+0 >680){
                    hitTheVillage++;
                    if (hitTheVillage ==1){
            ...
            if (explodeCount >= MAX_ICEBERG_EXPLODECOUNT) {
                state = STATE_DONE;
            }
        }
