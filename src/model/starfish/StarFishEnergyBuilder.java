...
public class StarFishEnergyBuilder extends StarFishBuilder {
    @Override
    public void buildShape() {
        ...
        this.getStar().starcoreOval3x = (int)this.getStar().location.x+26*3/4;
        this.getStar().starcoreOval3y = (int)this.getStar().location.y+26*3/4;
        this.getStar().starcoreOval3w = 10*3/4+1+1;
        this.getStar().starcoreOval3h = 10*3/4+1+1;
        
    }

    @Override
    public void buildColor() {
        this.getStar().color1 = new Color(231,110,31);
        this.getStar().color2 = new Color (127,235,198);
        this.getStar().color3 = new Color(137,235,127);
    ...
    public void buildStrategy() {
        this.getStar().starType = this.getStar().TYPE_STARFISHENERGY;
