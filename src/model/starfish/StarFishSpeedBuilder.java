...
public class StarFishSpeedBuilder extends StarFishBuilder {
    @Override
    ...
    public void buildColor() {
        this.getStar().color1 = new Color(127,208,235);
        this.getStar().color3 = new Color (127,235,183);
        this.getStar().color2 = new Color(183,235,127);
        this.getStar().whitecolor = new Color(233,230,224);
    }

    @Override
    public void buildStrategy() {
        this.getStar().starType = this.getStar().TYPE_STARFISHSPEED;
