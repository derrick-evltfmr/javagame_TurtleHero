...
public class StarFishLifeBuilder extends StarFishBuilder {
    @Override
    ...
    public void buildColor() {
        this.getStar().color1 = new Color(236,46,46);
        this.getStar().color2 = new Color (232,186,119);
        this.getStar().color3 = new Color(243,100,50);
        this.getStar().whitecolor = new Color(233,230,224);
    }

    @Override
    public void buildStrategy() {
        this.getStar().starType = this.getStar().TYPE_STARFISHLIFE;
